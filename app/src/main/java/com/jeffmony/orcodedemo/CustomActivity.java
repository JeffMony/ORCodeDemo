package com.jeffmony.orcodedemo;
...
import com.jeffmony.orcode.CaptureHelper;
import com.jeffmony.orcode.OnCaptureCallback;
import com.jeffmony.orcode.ViewfinderView;
import com.jeffmony.orcodedemo.utils.StatusBarUtils;

/**
 * 自定义扫码：当直接使用CaptureActivity
 * 自定义扫码，切记自定义扫码需在{@link Activity}或者{@link androidx.fragment.app.Fragment}相对应的生命周期里面调用{@link #mCaptureHelper}对应的生命周期
